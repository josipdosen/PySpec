...
class SystemInfo:
    ...
    def display_cpu_info(self):
        ...
        print("CPU L2 Cache:", self.cpu_info.get("l2_cache_size", "N/A"), "B")
        print("CPU L3 Cache:", self.cpu_info.get("l3_cache_size", "N/A"), "B")
        time.sleep(5)
    ...
    def display_all_info(self):
        '''Displays all system information and writes it to a file to the desktop'''
